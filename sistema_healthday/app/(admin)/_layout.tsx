 ...
 * Tab bar do painel de administrador.
 * CORRIGIDO: arquivo era "layout.tsx" (sem underscore) — ignorado pelo Expo Router.
 * CORRIGIDO: tab "especialistas" apontava para arquivo "especialista.tsx" (singular) — renomeado.
 */
...
export default function AdminLayout() {
  return (
    ...
    >
      ...
      />
      {/* CORRIGIDO: era "especialistas" mas arquivo se chamava "especialista.tsx" */}
      <Tabs.Screen
        name="especialistas"
        options={{
          title: 'especialistas',
