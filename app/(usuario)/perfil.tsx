...
export default function PerfilScreen() {
  ...
  const [modalSair, setModalSair] = useState(false); // ← confirmação de logout (Alert não funciona na web)
  ...
  function handleLogout() {
    // Alert.alert não funciona no Expo Web — usamos um modal próprio
    setModalSair(true);
  }
  ...
  return (
    <View style={[styles.container, { backgroundColor: tema.background }]}>
        ...
        <View style={[styles.menuCard, { backgroundColor: tema.card }]}>
          {MENU_ITEMS.map((item, idx) => (
            ...
            >
              ...
              <Text style={[styles.menuChevron, { color: tema.subtext }]}>
                ›
              </Text>
            </TouchableOpacity>
          ))}
          ...
          <View style={[styles.modalCard, { backgroundColor: tema.card }]}>
            <View style={styles.modalHeaderRow}>
              ...
              <TouchableOpacity onPress={() => setModalInfo(false)}>
                <Text style={[styles.modalFechar, { color: tema.subtext }]}>
                  ✕
                </Text>
              </TouchableOpacity>
            </View>

            <Text style={[styles.inputLabel, { color: tema.subtext }]}>
              Nome
            </Text>
            <TextInput
              style={[
      ...
      {/* ── Modal confirmar saída (substitui Alert.alert, que não funciona na web) ── */}
      <Modal
        visible={modalSair}
        animationType="fade"
        transparent={true}
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={[styles.modalSairCard, { backgroundColor: tema.card }]}>
            <Text style={[styles.modalSairTitulo, { color: tema.text }]}>
              Sair da conta
            </Text>
            <Text style={[styles.modalSairTexto, { color: tema.subtext }]}>
            ...
            <View style={styles.modalSairBotoes}>
              ...
              >
                <Text
                  style={[styles.modalSairBtnCancelarTxt, { color: tema.text }]}
                >
                  Cancelar
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[styles.modalSairBtn, styles.modalSairBtnConfirmar]}
                onPress={confirmarLogout}
                activeOpacity={0.8}
              >
                <Text style={styles.modalSairBtnConfirmarTxt}>Sair</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  modalSairBtnCancelar: {
    borderWidth: 1.5,
  },
  modalSairBtnCancelarTxt: {
    fontSize: 15,
    fontWeight: "700",
  },
  modalSairBtnConfirmar: {
    backgroundColor: HD.accent,
  },
  modalSairBtnConfirmarTxt: {
    fontSize: 15,
    fontWeight: "700",
    color: HD.white,
  },
